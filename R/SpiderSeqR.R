...
#'
#' SpiderSeqR integrates two different sources of sequencing metadata and automates the search and retrieval of the information.
#' 
#' 
#' 
#' 
...
#' \itemize{
#'   \item \code{\link{startSpiderSeqR}} - always run it before using SpiderSeqR
