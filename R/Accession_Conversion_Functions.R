...
#' \enumerate{
#'     \item Download the most up to date versions of SRAmetadb.sqlite and GEOmetadb.sqlite files - this is done by running \code{\link{startSpideR}}, specifying an appropriate argument for expiry period of database files
